...
<!--SIAP TABLES-->
<!--------------->
<resource schema="obscoretables">
  <meta name="title">ObsCore Tables</meta>
  ...
  <meta name="content.type">Catalog</meta>
	...
	<table id="obt" onDisk="True" adql="True">
		<mixin
	...
	<data id="import_content">
		...
		<fitsProdGrammar qnd="True">
			...
			<rowfilter procDef="__system__/products#define">
				<bind key="table">"obscoretables.obt"</bind>
			</rowfilter>
		</fitsProdGrammar>
   	...
   	<!--Crea tabla en la DB -->
    <make table="obt" rowmaker="build_obt"/>
  </data>
